...
class ContractManuallyCreateInvoice(models.TransientModel):
    ...
    contract_to_invoice_count = fields.Integer(compute="_compute_contract_to_invoice_ids")
    ...
    def _compute_contract_to_invoice_ids(self):
        if not self.invoice_date:
            ...
            contract_to_invoice_domain = self.env["contract.contract"]._get_contracts_to_invoice_domain(
                self.invoice_date
            )
