...
class PortalContract(CustomerPortal):
    ...
    def portal_my_contracts(self, page=1, date_begin=None, date_end=None, sortby=None, **kw):
        ...
        contracts = contract_obj.search(domain, order=order, limit=self._items_per_page, offset=pager["offset"])
    ...
    def portal_my_contract_detail(self, contract_contract_id, access_token=None, **kw):
        try:
            contract_sudo = self._document_check_access("contract.contract", contract_contract_id, access_token)
