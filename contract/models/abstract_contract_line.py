...
class ContractAbstractContractLine(models.AbstractModel):
    ...
    termination_notice_interval = fields.Integer(default=1, string="Termination Notice Before")
    ...
    def _compute_is_recurring_note(self):
        for record in self:
            record.is_recurring_note = record.display_type == "line_note" and record.note_invoicing_mode == "custom"
        ...
        for line in self:
            if line.automatic_price and line.product_id:
                pricelist = (
                    ...
                    or line.contract_id.partner_id.with_company(line.contract_id.company_id).property_product_pricelist
                )
                product = line.product_id.with_context(
                    ...
                    date=line.env.context.get("old_date", fields.Date.context_today(line)),
                )
