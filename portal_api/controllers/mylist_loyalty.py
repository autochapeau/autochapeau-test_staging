...
class MyListLoyaltyAPI(http.Controller):
    @http.route(
        "/v1/mylist/loyalty/history", type="json", auth="none", csrf=False, methods=["POST", "OPTIONS"], cors="*"
    )
    @authorization_required
    def v1_mylist_loyalty_history(self):
